package com.zhou.java.Spring.AOP.aspectjMethod;
...
public class AspectAdvice {
     ...
     */
    @Pointcut("execution(* com.zhou.java.Spring.AOP.*.*(..))")
     ...
     * @param jp
     */
    @Before(value = "execution(* com.zhou.java.Spring.AOP.*.*(..))")
     ...
     *            连接点
     */
    @Around(value = "execution(* com.zhou.java.Spring.AOP.*.*(..))")
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(* com.zhou.java.Spring.AOP.*.*(..))", throwing = "e")

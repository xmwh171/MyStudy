package com.zhou.base.Spring.AOP.aspectjMethod;
...
public class AspectAdvice {
     ...
     */
    @Pointcut("execution(* com.zhou.base.Spring.AOP.*.*(..))")
     ...
     * @param jp
     */
    @Before(value = "execution(* com.zhou.base.Spring.AOP.*.*(..))")
     ...
     *            连接点
     */
    @Around(value = "execution(* com.zhou.base.Spring.AOP.*.*(..))")
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(* com.zhou.base.Spring.AOP.*.*(..))", throwing = "e")
